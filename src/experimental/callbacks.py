...
class GradNormMonitor(pl.Callback):
    ...
    def on_after_backward(self, trainer: pl.Trainer, pl_module: LightningModule) -> None:
        """
        ...
        """
        grad_2norm: float = pl.utilities.grad_norm(pl_module, norm_type=2.0)[f"grad_2.0_norm_total"]

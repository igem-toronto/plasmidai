...
class LitEvo(L.LightningModule):
    def __init__(self, config):
        ...
        self.evo_full = Evo(model_name='evo-1-8k-base', config_path=config['evo_config_path'], model_path=config['evo_model_path'])
    ...
    def training_step(self, data, batch_idx):
        ...
        self.log("[INFO] Train Loss", loss, on_step=True,
    ...
    def validation_step(self, data, batch_idx):
        ...
        self.log("[INFO] Validation Loss", loss, on_step=True,
                 on_epoch=True, prog_bar=True, logger=True)
